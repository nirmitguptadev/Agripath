...
from dictionary.models import Crop, Disease

class Command(BaseCommand):
    help = 'Populates the database with detailed agricultural data for major Indian crops'

    def handle(self, *args, **kwargs):
        self.stdout.write('Populating expanded crop dictionary...')
        ...
        crops_data = [
            {
                ...
                "header_image": "crop_headers/wheat-cultivation-india.webp",
            ...
            },
            {
                ...
                "header_image": "crop_headers/paddy.jpg",
                "family": "Poaceae",
            ...
            },
            {
                ...
                "header_image": "crop_headers/Cotton-plants-in-a-field.webp",
                "family": "Malvaceae",
            ...
            },
            {
                ...
                "header_image": "crop_headers/sugar.webp",
                "family": "Poaceae",
            ...
            },
            {
                ...
                "header_image": "crop_headers/sweetcorn.webp",
                "family": "Poaceae",
            ...
            },
            {
                ...
                "header_image": "crop_headers/potato.webp",
                "family": "Solanaceae",
            ...
            },
            {
                ...
                "header_image": "crop_headers/Tomato_je.jpg",
                "family": "Solanaceae",
            ...
            },
            {
                ...
                "header_image": "crop_headers/mustard.jpg",
                "family": "Brassicaceae",
            ...
            },
            {
                ...
                "header_image": "crop_headers/Soybean.USDA.jpg",
            ...
            },
            {
                ...
                "header_image": "crop_headers/chickpeas.webp",
                "family": "Fabaceae",
        ...
        for crop_data in crops_data:
            diseases_data = crop_data.pop('diseases')
            crop = Crop.objects.create(**crop_data)
            self.stdout.write(f'Created crop: {crop.name}')
            
            for disease_data in diseases_data:
                Disease.objects.create(crop=crop, **disease_data)
                self.stdout.write(f'  - Added disease: {disease_data["name"]}')

        self.stdout.write(self.style.SUCCESS('Successfully populated crops database'))
